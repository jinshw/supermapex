...
//        mileagePosition.getNearPointByiObjects(com.supermap.data.Geometry[] geometries);
//        mileagePosition.getNearPointByiServer();


//        String cityName = URLDecoder.decode(roadcode, "UTF-8");
